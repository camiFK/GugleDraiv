...
INSERT INTO files (token, system_id, is_folder, file_path, file_ext, file_name, mime_type, content, name, file_hash, upload_date, is_public, file_url, folder_id, user_id)
VALUES 
