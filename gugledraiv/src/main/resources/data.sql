...
INSERT INTO users (token, userName) VALUES ("token1", "Jane Doe"); -- user_id=1
INSERT INTO users (token, userName) VALUES ("token2", "John Doe"); -- user_id=2
INSERT INTO users (token, userName) VALUES ("token3", "Mary Jane"); -- user_id=3


INSERT INTO file (token, systemId, isFolder, filePath, fileExt, fileName, mimeType, content, name, fileHash, uploadDate, isPublic, fileUrl, folderId, userId)
VALUES 
